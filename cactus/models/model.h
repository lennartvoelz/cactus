...
class Qwen3p5MoEModel : public Model {
public:
    Qwen3p5MoEModel();
    explicit Qwen3p5MoEModel(const Config& config);
    ~Qwen3p5MoEModel() override = default;
...
private:
    ...
    struct WeightNodeIDs {
        ...
        struct ExpertWeights {
            size_t w1_weight = 0;  // gate_proj
            size_t w3_weight = 0;  // up_proj
            size_t w2_weight = 0;  // down_proj
        };
        ...
        struct LayerWeights {
            ...
            size_t shared_expert_gate_weight = 0;
            size_t shared_expert_up_weight = 0;
            size_t shared_expert_down_weight = 0;
            size_t shared_expert_gate_proj_weight = 0;  // sigmoid gate
        };
